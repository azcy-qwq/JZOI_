...
//ios::sync_with_stdio(0);
    while(1){
        ++cnt;
        cout<<cnt<<"\n";
        system("2024-11-16-data.exe > 2024-11-16.in");
        system("2024-11-16-Lg-C.exe < 2024-11-16.in > 2024-11-16.out");
        system("temp3.exe < 2024-11-16.in > 2024-11-16.ans");
        if(system("fc 2024-11-16.ans 2024-11-16.out")){
            system("pause");
        }
    }
}