...
pair<__int256,__int256> aa[N];
int n;
bool cmp(pair<__int256,__int256> x,pair<__int256,__int256> y){
    __int256 x1=(x.first*x.second),x2=(y.first>y.second);
    return x1>x2;
}
__int256 t,qzh;
int main(){
